...
Géron, Aurélien. Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow, O'Reilly Media, Incorporated, 2022. ProQuest Ebook Central, http://ebookcentral.proquest.com/lib/uwa/detail.action?docID=30168989. Created from uwa on 2026-03-06 01:18:50. 
...
#### **780 | Appendix A: Machine Learning Project Checklist** 
...
**3.** Perform feature engineering, where appropriate: 
   ...
   - Add promising transformations of features (e.g., log( _x_ ), sqrt( _x_ ), _x_<sup>2</sup> , etc.). 

   - Aggregate features into promising new features. 

**Machine Learning Project Checklist | 781** 
...
**2.** Measure and compare their performance: 
   ...
   - For each model, use _N_ -fold cross-validation and compute the mean and stan‐ dard deviation of the performance measure on the _N_ folds. 
...
**782 | Appendix A: Machine Learning Project Checklist** 
...
> 1 Jasper Snoek et al., “Practical Bayesian Optimization of Machine Learning Algorithms”, _Proceedings of the 25th International Conference on Neural Information Processing Systems_ 2 (2012): 2951–2959. 

**Machine Learning Project Checklist | 783** 
...
#### **784 | Appendix A: Machine Learning Project Checklist** 
